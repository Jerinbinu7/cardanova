...
var c2 = class {
  ...
  send(e2) {
    ...
    "function" == typeof AbortController && this.#i && (this.#n = new AbortController(), typeof EventTarget < "u" && this.#n.signal instanceof EventTarget && (r2.signal = this.#n.signal)), typeof document < "u" && (r2.credentials = this.withCredentials ? "include" : "omit"), fetch(this.#t, r2).then((e3) => (e3.headers.forEach((e4, t3) => {
      this.#r += `${t3}: ${e4}\r
`;
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-B7X4JCZQ.js").then(function(n4) {
...
function _documentsExists(client, httpRequest, ids, opts = {}) {
  ...
  const batches = [];
  for (let i2 = 0; i2 < ids.length; i2 += DOCUMENTS_EXISTS_BATCH_SIZE)
    batches.push(ids.slice(i2, i2 + DOCUMENTS_EXISTS_BATCH_SIZE));
...
function _requestObservable(client, httpRequest, options) {
  const callSiteStack = new Error(), uri = options.url || options.uri, config2 = client.config(), canUseCdn = typeof options.canUseCdn > "u" ? ["GET", "HEAD"].indexOf(options.method || "GET") >= 0 && isData(client, uri) : options.canUseCdn;
  ...
  if (tag && options.tag !== null && (options.query = { tag: requestTag(tag), ...options.query }), ["GET", "HEAD", "POST"].indexOf(options.method || "GET") >= 0 && isQuery(client, uri)) {
    ...
    perspectiveOption === "previewDrafts" || perspectiveOption === "drafts") && useCdn && (useCdn = false, printCdnPreviewDraftsWarning2()));
    const variantOption = options.variant || config2.variant;
...
var eventSourcePolyfill = defer(() => import("./browser-JGFQLQUU.js")).pipe(
...
var ObservableSanityClient = class _ObservableSanityClient {
  ...
  constructor(httpRequest, config2 = defaultConfig) {
    this.config(config2), this.#originalHttpRequest = httpRequest;
   ...
   */
  clone() {
    return new _ObservableSanityClient(this.#originalHttpRequest, this.config());
  }
  config(newConfig) {
    if (newConfig === void 0)
  ...
  withConfig(newConfig) {
    ...
    return new _ObservableSanityClient(this.#originalHttpRequest, {
      ...thisConfig,
      ...newConfig,
      stega: {
        ...thisConfig.stega || {},
...
var SanityClient = class _SanityClient {
   ...
   */
  clone() {
    return new _SanityClient(this.#originalHttpRequest, this.config());
  }
  config(newConfig) {
    if (newConfig === void 0)
      return { ...this.#clientConfig };
  ...
  withConfig(newConfig) {
    const thisConfig = this.config();
    return new _SanityClient(this.#originalHttpRequest, {
      ...thisConfig,
      ...newConfig,
      stega: {
        ...thisConfig.stega || {},
